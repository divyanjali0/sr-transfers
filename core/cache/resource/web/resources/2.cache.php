<?php  return array (
  ...
  array (
    ...
    <main class="main">
        ...
        <section id="travel-about" class="travel-about section">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="mt-4 journey-timeline" data-aos="fade-up" data-aos-delay="200">
                            <div class="timeline-header text-center mb-5">
                                <h3 class="about-title">Milestones in Our Adventure</h3>
                            ...
                            <div class="timeline-container">
                                ...
                                <div class="timeline-milestone mb-0" data-aos="slide-left" data-aos-delay="600">
                                    <div class="milestone-marker">
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1762927892,
    'editedby' => 1,
    'editedon' => 1763027185,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1762927920,
    'publishedby' => 1,
    'menutitle' => '',
    'content_dispo' => 0,
    'hidemenu' => 0,
                        ...
                        <div class="cta-banner" data-aos="zoom-in" data-aos-delay="300">
                            <div class="cta-overlay">
                                <div class="cta-content">
                                    ...
                                    <p>Join thousands of travelers who\'ve discovered the difference authentic, responsible travel makes.</p>
                                    <div class="cta-buttons">
                                        <a href="index.php?id=3" class="btn btn-primary me-3">Explore Destinations</a>
                                        <a href="index.php?id=5" class="btn btn-outline">Contact Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
