<?php  return array (
  ...
  'access_category_create' => 'Add Category Access',
  ...
  'access_category_err_remove' => 'An error occurred while trying to delete the Category ACL.',
  'access_category_remove' => 'Delete Category Access',
  'access_category_update' => 'Edit Category Access',
  'access_confirm_remove' => 'Are you sure you want to delete this security access control record?',
  'access_context_management_msg' => 'Manage User Group member access to Contexts and optionally apply access policies.',
  'access_context_create' => 'Add Context Access',
  ...
  'access_context_err_remove' => 'An error occurred while trying to delete the Context ACL.',
  'access_context_remove' => 'Delete Context Access',
  'access_context_update' => 'Edit Context Access',
  ...
  'access_err_remove' => 'An error occurred while trying to delete the ACL!',
  'access_err_save' => 'Error saving ACL!',
  'access_grid_empty' => 'No ACLs to display',
  'access_grid_paginate' => 'Displaying ACLs {0} - {1} of {2}',
  'access_namespace_create' => 'Add Namespace Access',
  'access_namespace_remove' => 'Delete Namespace Access',
  'access_namespace_update' => 'Edit Namespace Access',
  ...
  'access_permissions_users_tab' => 'Here you can see which user groups have been set up. You can also create new groups, rename groups, delete groups and see which users are members of the different groups. To add a new user to a group or to delete a user from a group, edit the user directly.',
  ...
  'access_resourcegroup_create' => 'Add Resource Group Access',
  'access_resourcegroup_remove' => 'Delete Resource Group Access',
  'access_resourcegroup_update' => 'Edit Resource Group Access',
  ...
  'access_rgroup_err_remove' => 'An error occurred while trying to delete the Resource Group ACL.',
  'access_source_create' => 'Add Media Source Access',
  'access_source_err_ae' => 'An ACL for that Media Source already exists.',
  'access_source_remove' => 'Delete Media Source Access',
  'access_source_update' => 'Edit Media Source Access',
  ...
  'resource_group_access_remove' => 'Delete Resource from Group',
  'resource_group_access_remove_confirm' => 'Are you sure you want to delete this resource from the resource group?',
  ...
  'resource_group_err_remove' => 'An error occurred while trying to delete the resource group.',
  'resource_group_remove' => 'Delete Resource Group',
  'resource_group_remove_confirm' => 'Are you sure you want to delete the resource group: "[[+resource_group]]"?',
  ...
  'resource_group_resource_err_remove' => 'An error occurred while trying to delete the resource from the resource group.',
  'resource_group_untitled' => 'Untitled Resource Group',
  'resource_group_update' => 'Edit Resource Group',
  ...
  'resource_group_automatic_access_desc' => 'Note: You may have to flush sessions after creating the Resource Group if you check any of the options below.',
  'resource_group_access_admin' => 'Automatically Give Administrator Group Access',
  ...
  'user_group_category_access' => 'Element Categories',
  'user_group_category_access_msg' => 'Set the Element Categories this User Group can access.',
  ...
  'user_group_category_remove_confirm' => 'Are you sure you want to delete this Category from this User Group?',
  'user_group_context_access' => 'Contexts',
  'user_group_context_access_msg' => 'Set the Contexts this User Group can access.',
  ...
  'user_group_context_remove_confirm' => 'Are you sure you want to delete this Context from this User Group?',
  'user_group_resourcegroup_access' => 'Resource Groups',
  'user_group_resourcegroup_access_msg' => 'Set the Resource Groups this User Group can access.',
  ...
  'user_group_resourcegroup_remove_confirm' => 'Are you sure you want to delete this Resource Group from this User Group?',
  'user_group_resourcegroup_resource_group_desc' => 'The Resource Group to grant access to.',
  'user_group_source_access' => 'Media Sources',
  'user_group_source_access_msg' => 'Set the Media Sources this User Group can access.',
  ...
  'user_group_source_remove_confirm' => 'Are you sure you want to delete this Media Source from this User Group?',
  ...
  'user_group_namespace_access' => 'Namespaces',
  'user_group_namespace_access_desc' => 'Set the Namespaces this User Group can access.',
  'user_group_namespace_namespace_desc' => 'The Namespace to grant access to.',
  'user_group_namespace_authority_desc' => 'The minimum Role that will have access to the Permissions in the selected Policy. Roles with stronger Authority (lower numbers) will inherit this access as well. Most situations can leave this at "Member".',
  'user_group_namespace_policy_desc' => 'The Policy to apply to this Namespace for this User Group. This will grant all Users in this User Group with the selected minimum Role all the Permissions in the Policy.',
  'access_rgroup_remove' => 'Delete Resource Group Access',
  'access_rgroup_update' => 'Edit Resource Group Access',
);